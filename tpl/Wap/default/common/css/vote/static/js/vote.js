var _vote = {
    ...
    _post: function() {
	   ...
	   if (_title == "") {
        ...
        _$("./index.php?g=Wap&m=Vote&a=VoteAjax", formdate, "请稍候", "_vote._ok");
    },
    _ok: function(json) {
        if (json.state == "0") {
        ...
        dataForWeixin.path = "./index.php?g=Wap&m=Vote&a=commentList&id=" + json.vid + "&token=" + json.token;
        ...
        dataForWeixin.callback = function() {
            _$("./index.php?g=Wap&m=Vote&a=commentList&id=" + json.vid+"&token=" + json.token, "", "");
        };
        _system._guide();
    }
};
...
(function() {
	...
	jq('#vote_time').scroller({preset: 'datetime', minDate: new Date(), maxDate: new Date(2020, 7, 30, 15, 44), stepMinute: 5, theme: 'default', mode: 'mode', display: 'top', lang: 'zh', dateFormat: 'yy-mm-dd'});
})();
