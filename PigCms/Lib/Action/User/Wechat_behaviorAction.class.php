...
class Wechat_behaviorAction extends UserAction{
    ...
    public function _modules(){
        return array('home' => array('name' => '微网站'), 'text' => array('name' => '文本请求', 'detail' => 1), 'member_card_set' => array('name' => '会员卡'), 'lottery' => array('name' => '推广活动', 'detail' => 1), 'help' => array('name' => '帮助'), 'wedding' => array('name' => '婚庆喜帖', 'detail' => 1), 'img' => array('name' => '图文消息', 'detail' => 1), 'selfform' => array('name' => '万能表单', 'detail' => 1), 'host' => array('name' => '通用订单', 'detail' => 1), 'panorama' => array('name' => '全景', 'detail' => 1), 'usernamecheck' => array('name' => '账号审核'), 'album' => array('name' => '相册'), 'vote' => array('name' => '投票', 'detail' => 1), 'product' => array('name' => '商城', 'detail' => 1), 'voiceresponse' => array('name' => '语音消息'), 'estate' => array('name' => '房产'), 'follow' => array('name' => '关注'),);
    }
    public function modelName($str){
        $array = array('3G微网站' => '3G微网站', 'Lottery' => '1', 'Member_card_set' => '会员卡', 'Wedding' => '喜帖', 'Img' => '图文信息', '帮助' => '帮助提示', 'Selfform' => '万能表单功能', 'Text' => '文本信息', 'Host' => '订单信息', '帐号审核' => '帐号审核', '3g相册' => '帐号审核', 'Vote' => '投票活动', 'Product' => '电商产品',);
        return $array[$str];
    }
}
?>